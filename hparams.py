...
class Hparams():
    def __init__(self):
        ...
        self.trans_dir = '/data/datasheet/omr/train/words'
        
        #В этой папке лежат  jpg файлы изображений
        self.image_dir = '/data/datasheet/omr/train/images'

        self.vocabulary_dir = '/data/datasheet/omr/train/vocabulary_semantic.txt'
...
def load_texts(image_dir,trans_dir,vocabulary_dir):
    letters,lines,names = [],[],[]
    ...
    vocabulary_file = open(vocabulary_dir, 'r')
    letters = vocabulary_file.read().splitlines()
    return names,lines,letters
