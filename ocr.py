...
from hparams import Hparams, process_texts, load_texts, text_to_labels, labels_to_text, phoneme_error_rate, process_image, generate_data, count_parameters
...
if __name__ == '__main__':
    ...
    if it_train:
        ...
        names, lines, letters = load_texts(hp.image_dir,hp.trans_dir,hp.vocabulary_dir)
    ...
    print('letters list:',len(letters),':', ' '.join(letters))
